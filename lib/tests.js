...
const getName = (name) => name.replace(/[^\w]/g, '-');
...
module.exports = {
    resourceLifeCycle, resourceResizeCycle, resourceRename, show, remove, run, delay,
    getToken, getRandomFile, resourceAccessCycle, RECIPIENT, downloadFile, accessRuleLifeCycle,
    passwordLifeCycle, getName, credentialsLifeCycle,
    iso_url, disk_url
};
