...
const generateSshKey = (comment = 'autogenerated') => new Promise(function (resolve, reject) {
...
const sshExecute = (command, connection) => new Promise(function (resolve, reject) {
    ...
    }).connect(Object.assign({}, {port: 22}, connection));
});


module.exports = {
    resourceLifeCycle, credentialsLifeCycle, resourceResizeCycle, resourceRename, show, remove, run, delay,
    getToken, getRandomFile, resourceAccessCycle, generateSshKey, sshExecute, RECIPIENT,
    iso_url,
};
