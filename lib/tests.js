...
const iso_url = 'https://distro.ibiblio.org/tinycorelinux/9.x/x86/release/Core-current.iso';
...
module.exports = {
    ...
    getToken, getRandomFile, resourceAccessCycle, RECIPIENT, downloadFile,
    iso_url, disk_url,
};
