...
const subresourceLifeCycle = (options = {}) => async t => {
    ...
    const commonParams = `--${getOption(options.resourceType)} '${options.resourceId}'`;
...
module.exports = {
    resourceLifeCycle, credentialsLifeCycle, subresourceLifeCycle, resourceResizeCycle, resourceRename, show, remove, run, delay,
