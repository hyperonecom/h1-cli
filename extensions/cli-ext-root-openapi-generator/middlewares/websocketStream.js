...
export const upload = (ws, filePath, options = {}) => new Promise((resolve, reject) => {
    ...
    ws.once('message', message => {
        ...
        transferData(stream, filePath, fileSize, parseInt(start), options)
            .on('finish', resolve);
...
const transferData = (stream, filePath, fileSize, start, options = {}) => {
