...
```h1 agent enabled-service add | --enabled-service ENABLED-SERVICE [--enabled-service ENABLED-SERVICE ...] --agent AGENT```
### Required arguments

| Name | Default | Description |
| ---- | ------- | ----------- |
| ```--enabled-service ENABLED-SERVICE [--enabled-service ENABLED-SERVICE ...]``` |  | Enabled service. The parameter may occur repeatedly |
| ```--agent AGENT``` |  | Agent ID or name |
...
```h1 agent enabled-service delete | --enabled-service ENABLED-SERVICE [--enabled-service ENABLED-SERVICE ...] --agent AGENT```
### Required arguments
