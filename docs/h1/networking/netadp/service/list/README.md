...
* [API reference](https://api.hyperone.com/v2/docs#operation/networking_project_netadp_service_list)
...
```h1 networking netadp service list --project 5f64e2468c71177993874510 --netadp 5f577a24494c5cfdec7830e5```
