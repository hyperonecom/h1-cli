...
* [API reference](https://api.hyperone.com/v2/docs#operation/networking_project_firewall_egress_list)
...
```h1 networking firewall egress list --project 5f64e2468c71177993874510 --firewall 5f577a24494c5cfdec7830e5```
