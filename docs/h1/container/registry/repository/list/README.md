...
* [API reference](https://api.hyperone.com/v2/docs#operation/container_project_registry_repository_list)
...
```h1 container registry repository list --project 5f64e2468c71177993874510 --registry 5f577a24494c5cfdec7830e5```
