...
* [API reference](https://api.hyperone.com/v2/docs#operation/website_project_instance_sideapp_list)
...
```h1 website instance sideapp list --project 5f64e2468c71177993874510 --instance 5f577a24494c5cfdec7830e5```
