...
* [API reference](https://api.hyperone.com/v2/docs#operation/recovery_project_backup_export)
...
| ```--bucket {id-or-uri}```                         | Backup bucket. Provide ID or URI of storage/bucket. Requires permissions storage/bucket/upload            |
| ```--skeleton```                                   | -                                                                                                         |
