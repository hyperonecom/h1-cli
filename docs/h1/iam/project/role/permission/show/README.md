...
* [API reference](https://api.hyperone.com/v2/docs#operation/iam_project_role_permission_get)
...
```h1 iam project role permission show --project 5f64e2468c71177993874510 --role 5f72c96b02fbdad8a048fa40 --permission 5f72ce6102fbdad8a048fb38```
