...
* [API reference](https://api.hyperone.com/v2/docs#operation/iam_project_policy_service_list)
...
```h1 iam project policy service list --project 5f64e2468c71177993874510 --policy 5f72c96b02fbdad8a048fa40```
