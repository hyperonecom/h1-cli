...
* [API reference](https://api.hyperone.com/v2/docs#operation/insight_project_journal_service_list)
...
```h1 insight journal service list --project 5f64e2468c71177993874510 --journal 5f577a24494c5cfdec7830e5```
