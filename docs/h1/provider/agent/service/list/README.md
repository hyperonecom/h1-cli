...
* [API reference](https://api.hyperone.com/v2/docs#operation/provider_project_agent_service_list)
...
```h1 provider agent service list --project 5f64e2468c71177993874510 --agent 5f577a24494c5cfdec7830e5```
