...
* [API reference](https://api.hyperone.com/v2/docs#operation/database_project_instance_credential_create)
...
```h1 database instance credential create --project 5f64e2468c71177993874510 --instance 5f577a24494c5cfdec7830e5 --name instance-credential --type plain --value xxxxxx```
