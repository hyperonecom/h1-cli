...
* [API reference](https://api.hyperone.com/v2/docs#operation/storage_project_disk_resize)
...
```h1 storage disk resize --project 5f64e2468c71177993874510 --disk 5f577a24494c5cfdec7830e5 --size 10```
