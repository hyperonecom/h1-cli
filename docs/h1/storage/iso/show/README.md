...
* [API reference](https://api.hyperone.com/v2/docs#operation/storage_project_iso_get)
...
```h1 storage iso show --project 5f64e2468c71177993874510 --iso 5f577a24494c5cfdec7830e5```
