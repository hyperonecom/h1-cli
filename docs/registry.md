# TOC
  ...
  * [h1 registry credential](#h1-registry-credential) - Manage your credentials of Registry
    ...
    * [h1 registry credential password](#h1-registry-credential-password) - Manage your password Registry
      ...
      * [h1 registry credential password rename](#h1-registry-credential-password-rename) - Rename password credential of Registry
      * [h1 registry credential password delete](#h1-registry-credential-password-delete) - Delete password credential of Registry
      * [h1 registry credential password add](#h1-registry-credential-password-add) - Add password credential of Registry
      * [h1 registry credential password list](#h1-registry-credential-password-list) - List password credential of Registry
...
List credential of Registry

### Syntax

```h1 registry credential list | --registry REGISTRY```
### Example

```bash
h1 registry credential list --registry my-registry
```
...
## h1 registry credential show

Show credential of Registry

### Syntax

```h1 registry credential show | --registry REGISTRY --credential CREDENTIAL```
### Example
...
Show password credential of Registry
...
| ---- | ------- | ----------- |
| ```--registry REGISTRY``` |  | Registry ID or name |
| ```--password PASSWORD``` |  | Password credential of Registry ID or name |

## h1 registry credential password rename

Rename password credential of Registry
...
Delete password credential of Registry
...
Add password credential of Registry
